...
class HelpScene(Scene):
    ...
    def __init__(self, screen: pygame.Surface,
        ...
        self.sections = [
            ("Objective", [
                "- You win the game by scoring more points than your opponents.",
                "- This can be achieved by by placing cards, completing structures,"
                "  and wisely placing your figures.",
