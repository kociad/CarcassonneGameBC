...
def clear_font_cache() -> None:
    """Clear cached pygame font instances."""
    _FONT_CACHE.clear()


def refresh_theme_maps() -> None:
    """Refresh derived theme maps after runtime changes."""
...
def set_theme_value(name: str, value: object) -> None:
    """Update a theme attribute and refresh derived values."""
    if name not in globals():
        raise AttributeError(f"Unknown theme attribute: {name}")
    globals()[name] = value
    refresh_theme_maps()
