...
THEME_BUTTON_PRESSED_BG_COLOR: Color = (22, 22, 22, 0)
# Default text
...
THEME_BUTTON_HOVER_TEXT_COLOR: Color = (205, 183, 82)
# Pressed text
# Text color for pressed buttons; RGB tuple (0-255 per channel).
THEME_BUTTON_PRESSED_TEXT_COLOR: Color = (159, 141, 56)
# Disabled state
...
THEME_DROPDOWN_HIGHLIGHT_COLOR: Color = (235, 225, 178, 255)
# Hover state
...
THEME_SLIDER_BG_COLOR: Color = (42, 42, 42, 100)
...
THEME_SLIDER_TRACK_ACTIVE_COLOR: Color = (159, 141, 56, 255)
# Hover state
# Slider border color when hovering handle; RGB tuple (0-255 per channel).
THEME_SLIDER_HOVER_BORDER_COLOR: Color = (50, 50, 50, 0)
# Disabled state
...
THEME_SLIDER_DISABLED_BORDER_COLOR: Color = (80, 80, 80, 0)
...
# Downscale factor for UI alpha blur; lower values blur more but introduce
...
THEME_SCENE_HEADER_TEXT_COLOR: Color = (205, 183, 82)
